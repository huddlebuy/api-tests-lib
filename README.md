...
This library simplifies the api tests process. It is built on rest-assured and testng. Latest version: 1.2.1.
...
[here](https://cdn.rawgit.com/chinenyeze/api-tests-lib/1.2.1/doc/Documentation.html) for last tagged version.
