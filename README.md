...
This library simplifies the api tests process. It is built on rest-assured and testng. Latest version: 1.1.29.
...
[here](https://cdn.rawgit.com/chinenyeze/api-tests-lib/1.1.29/doc/Documentation.html) for last tagged version.
